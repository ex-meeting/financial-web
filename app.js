...
const categories = [
  ...
  },
  {
    ...
    fields: [
      ...
      { type: "radio", name: "educationLevel", label: "ระดับการศึกษา", options: ["ปริญญาตรี", "ปริญญาโท", "ปริญญาเอก"], required: true },
      { type: "text", name: "semester", label: "ภาคการศึกษา/ปีการศึกษา", required: true },
      { type: "money", name: "amount", label: "จำนวนเงิน", required: true }
    ]
  },
...
const GOOGLE_SHEET_WEB_APP_URL = "https://script.google.com/a/macros/it.kmitl.ac.th/s/AKfycbynD1MIeUtgYIWPo_nsfbPizr-DqmXkYUapvWNPXpJ45X8qZ7vSYGxqUKK-_ZT-sT8w/exec";
